        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a 
                  href="https://terms-influencers-nepal.vercel.app/" 
                  target="_blank" 
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-2 text-gray-300">
                ...
                <a href="tel:9822798699" className="hover:text-white transition-colors">
                  9822798699
                </a>
              </li>
              <li className="flex items-center gap-2 text-gray-300">
                ...
                <a href="mailto:admin@influencersnepal.com" className="hover:text-white transition-colors">
                  admin@influencersnepal.com
                </a>
              </li>
              <li className="flex items-start gap-2 text-gray-300">
                <svg className="h-4 w-4 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
